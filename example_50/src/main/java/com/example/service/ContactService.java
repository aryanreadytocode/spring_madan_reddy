...
import com.example.config.AryanSchoolProps;
...
public class ContactService {
    ...
    @Autowired
    AryanSchoolProps aryanSchoolProps;
...
//        contact.setCreatedAt(LocalDateTime.now());
    ...
    public Page<Contact> findMsgsWithOpenStatus(int pageNum, String sortField, String sortDir){
        int pageSize = aryanSchoolProps.getPageSize();
        if (null != aryanSchoolProps.getContact() && null!=aryanSchoolProps.getContact().get("pageSize")) {
            pageSize = Integer.parseInt(aryanSchoolProps.getContact().get("pageSize").trim());
        }
